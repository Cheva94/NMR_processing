...
def main():
    ...
    if Back == None:
        t, decay, nS, RDT, RG, att, RD, p90, p180, tEcho, nEcho = CPMG_file(File, nini)
        decay = PhCorr(decay)
        Back = "Nein!"
    else:
        t, decay, nS, RDT, RG, att, RD, p90, p180, tEcho, nEcho = CPMG_file(File, nini)
...
if __name__ == "__main__":
    ...
    parser.add_argument('exponential_fit', help = "Fits exponential decay. Must choose mono, bi or tri to fit with 1, 2 or 3 exponentials, respectively.", choices=['mono', 'bi', 'tri'])
